...
execute if score @s tpaccept matches 0 as @a[tag=tpa.sender] run function minecraft:untag_older_senders
execute as @a[tag=tpa.sender] run function minecraft:accept_tpa
